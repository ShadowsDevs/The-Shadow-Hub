...
blueprint1() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/ShadowsDevs/The-Shadow-Hub/refs/heads/main/srv/thame/blueprint.sh)
  pause
}
...
blueprint2() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/ShadowsDevs/The-Shadow-Hub/refs/heads/main/srv/thame/blueprint-2.sh)
  pause
}
...
while true; do
  ...
  case $opt in
    1) blueprint1 ;;
    2) blueprint2 ;;
    3) bash <(curl -s https://raw.githubusercontent.com/ShadowsDevs/The-Shadow-Hub/refs/heads/main/srv/thame/fix.sh) ;;
